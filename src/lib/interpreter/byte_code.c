...
{
*current_frame *temp = stack_top(current_frame->operand_stack);
*current_frame value = *temp;
...
char buffer[256];
        char *string = get_utf8_value(utf8_index, current_frame->constant_pool), buffer);
...
*index_node *temp = stack_top(current_frame->operand_stack);
*index_node value = *temp;
stack_pop(current_frame->operand_stack);
    int index = *((int *)(index_node->data));
    stack_pop(current_frame->operand_stack);

*array_ref_node *temp = stack_top(current_frame->operand_stack);
*array_ref_node value = *temp;
stack_pop(current_frame->operand_stack);
...
*value_node *temp = stack_top(current_frame->operand_stack);
...
*current_frame value = *temp;
stack_pop(current_frame->operand_stack);
*value *temp = stack_top(current_frame->operand_stack);
*value value = *temp;
stack_pop(current_frame->operand_stack);
    stack_push(current_frame->operand_stack, value);
}
...
*current_frame value = *temp;
stack_pop(current_frame->operand_stack);
    void *value1stack_pop(current_frame->operand_stack);
    void *value2stack_pop(current_frame->operand_stack);
...
stack_pop(current_frame->operand_stack);
    void *value1stack_pop(current_frame->operand_stack);
    void *value2stack_pop(current_fram->operand_stack);
    void *value3stack_pop(current_frame->operand_stack);
    stack_push(current_frame->operand_stack, value1);
...
stack_pop(current_frame->operand_stack);
    ...
    void *value2stack_pop(current_frame->operand_stack);
    void *value3stack_pop(current_frame->operand_stack);
    void *value4stack_pop(current_frame->operand_stack);
    stack_push(current_frame->operand_stack, value2);
    stack_push(current_frame->operand_stack, value1);
...
*current_frame value = *temp;
stack_pop(current_frame->operand_stack);
value1 *temp = stack_top(current_frame->operand_stack);
value1 value = *temp;
stack_pop(current_frame->operand_stack);
    (int * value = *(((int * *)temp);
    stack_pop(current_frame->operand_stack);(current_frame->operand_stack));
value2 *temp = stack_top(current_frame->operand_stack);
value2 value = *temp;
stack_pop(current_frame->operand_stack);
    (int * value = *(((int * *)temp);
    stack_pop(current_frame->operand_stack);(current_frame->operand_stack));
...
*current_frame value = *temp;
stack_pop(current_frame->operand_stack);
divisor *temp = stack_top(current_frame->operand_stack);
divisor value = *temp;
stack_pop(current_frame->operand_stack);
    (int * value = *(((int * *)temp);
    stack_pop(current_frame->operand_stack);(current_frame->operand_stack));
dividend *temp = stack_top(current_frame->operand_stack);
dividend value = *temp;
stack_pop(current_frame->operand_stack);
    (int * value = *(((int * *)temp);
    stack_pop(current_frame->operand_stack);(current_frame->operand_stack));
...
*current_frame value = *temp;
stack_pop(current_frame->operand_stack);
shift *temp = stack_top(current_frame->operand_stack);
shift value = *temp;
stack_pop(current_frame->operand_stack);
    (int * value = *(((int * *)temp);
    stack_pop(current_frame->operand_stack);(current_frame->operand_stack));
