#ifndef JVM_BYTE_CODE_ARRAY
#define JVM_BYTE_CODE_ARRAY

#include "lib/interpreter/byte_code.h"

typedef void (*opcode_function)(MethodData *);
opcode_function jvm_opcodes[202] = {
    ...
    &if_icmpge, &if_icmpgt,   &if_icmple,     &if_acmpeg,     &if_acmpne,    &jvm_goto,
    &jsr,       &ret,         &tableswitch,   &lookupswitch,  &ireturn,      &lreturn,
    &freturn,   &dreturn,     &areturn,       &jvm_return,    &getstatic,    &putstatic,
